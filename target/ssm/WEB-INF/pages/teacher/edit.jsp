...
<main role="main">
    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/teacher/update/${teacher.teach_id}" method="post">
            <div class="form-group"  >
                <label for="teach_id">教师id</label>
                <input type="text" class="form-control" id="teach_id" name="teach_id" value="${sessionScope.userId}"  readonly required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sex" name="sex" value="${teacher.sex}" required>
            </div>
            <div class="form-group">
                <label for="oldPassword">旧密码</label>
                <input type="password" class="form-control" id="oldPassword" name="oldPassword" value="${teacher.password}" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary">确定</button><a href="${pageContext.request.contextPath}/teacher/index" class="btn btn-primary">返回</a>
        </form>
