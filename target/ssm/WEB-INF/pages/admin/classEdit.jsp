...
<main role="main">
    ...
    <div class="container">
        <%--<div class="row justify-content-md-center">--%>
                ...
                <form action="${pageContext.request.contextPath}/admin/updateClass" method="post" autocomplete="off">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Text input with dropdown button" placeholder="请输入系名" name="department" id="departmentName" value="${class_.department}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">班级编号</span>
                        </div>
                        <input type="text" class="form-control" placeholder="班级编号" name="class_id" aria-label="class_id" aria-describedby="basic-addon1" id="class_id" value="${class_.class_id}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon2">班级名称</span>
                        </div>
                        <input type="text" class="form-control" placeholder="班级名称" name="name" aria-label="name" aria-describedby="basic-addon2" id="name" value="${class_.name}">
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <%--/*验证码输入框*/--%>
